...
3. Link the existing Upstash database used by `signalparser`, or copy its `KV_REST_API_URL` and `KV_REST_API_TOKEN` into this project's Vercel environment. Keys are isolated under `dip-alerts:v1:*`.
