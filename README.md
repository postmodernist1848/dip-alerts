...
4. Add `TELEGRAM_BOT_TOKEN`, `TELEGRAM_CHAT_ID`, `CIFRA_API_KEY`, `CIFRA_API_SECRET`, and `SCHEDULER_SECRET` to the Production environment. `CIFRA_API_BASE` is optional.
